...
<form method="POST" action="{{url('update-data/'.$post->id)}} " enctype="multipart/form-data">
    @csrf
    @method('PUT')
    @if ($errors->any())
    ...
    <ul >
        ...
        <li><label for="image">Image</label><input type="file" value = "{{ $post->post_image }}" name="post_image" />
        <img src="{{ asset('uploads/images/'.$post->post_image) }}" alt="image" class="card-image"></li>
